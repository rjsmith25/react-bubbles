...
- [ ] What steps can you take in your web apps to keep your data secure?
      you can create a login to authenticate and make sure they are authorized to go to a route.

- [ ] Describe how web servers work.

when ever you enter a url in browser and press go it contacts a server which is just another computer on the internet that responds sending back data, example html css and javascript.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

the http methods that can be mapped to crud is post, get, put and delete when talking to an api server.
